#.libPaths( c(.libPaths(), "/data/sse/scientific-software/cinumell/rmagma/gpuRcublas/lib") )
library(gpuRcuda, lib.loc= "/data/sse/scientific-software/cinumell/rmagma/gpuRcublas/lib")
library(testthat)
